...
(function () {
  ...
  function renderDestinations(list) {
    ...
    list.filter((d) => d && d.name).forEach((dest, index) => {
      ...
      card.setAttribute('aria-label', `Pedir orçamento para ${dest.name}`);
      ...
      body.innerHTML = `
        ...
        <div class="destination__foot">
          ...
          <span class="destination__cta">Pedir orçamento
      ...
      card.addEventListener('click', () => pickDestination(dest.name));
